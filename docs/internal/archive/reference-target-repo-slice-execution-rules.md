> **Referenzdokument — nicht die Laufzeitregel dieses Repos.**
> Herkunft: `docs/internal/SLICE_EXECUTION_RULES.md` der Ruhestandsuite (Zielrepo), Stand der Übernahme 2026-08-10.
> Zweck hier: Beleg des manuellen Verfahrens, das der Orchestrator automatisieren soll.
> Bei Widersprüchen gilt laut diesem Dokument `AGENTS.md` des Zielrepos — siehe `reference-target-repo-agents.md`.
