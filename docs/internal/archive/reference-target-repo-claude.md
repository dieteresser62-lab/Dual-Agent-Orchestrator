...
> Herkunft: `CLAUDE.md` der Ruhestandsuite (Zielrepo), Stand der Übernahme 2026-08-10.
> Zweck hier: Beleg des manuellen Verfahrens, das der Orchestrator automatisieren soll.
> Die Rollendatei des Orchestrators ist und bleibt `CLAUDE.md` im Wurzelverzeichnis dieses Repos; sie hat einen anderen Inhalt.
