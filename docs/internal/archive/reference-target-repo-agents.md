...
> Herkunft: `AGENTS.md` der Ruhestandsuite (Zielrepo), Stand der Übernahme 2026-08-10.
> Zweck hier: Beleg des manuellen Verfahrens, das der Orchestrator automatisieren soll.
> Die Laufzeitregel des Orchestrators ist und bleibt `AGENTS.md` im Wurzelverzeichnis dieses Repos.
