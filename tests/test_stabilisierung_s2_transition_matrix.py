...
BRIDGE_ERROR_MARKERS = ('artifact batch requires at least two entries',
...
DRIVER_DIVERGENCE_MESSAGES = Counter({'workflow projection checkpoint path differs from its cursor': 2,
...
EXPECTED_COMPARISON_COUNTS = {'src/artifact_resume.py:resolve_resume_state': 4,
 ...
 'src/artifact_replay.py:_validate_bound_record_references': 25,
...
EXPECTED_STRICT_BODY_DIGESTS = {'src/artifact_resume.py:require_workflow_status_prefix': '964d356480288034c6dc52de377c2326c06d2db50d6aae52fd2b3d5dbcc5bdec',
 'src/artifact_resume.py:require_workflow_event_prefix': '54d2738e13e4689a26918fe4ca255e8010f1d064a30a3e780266b2b40e2f8827',
