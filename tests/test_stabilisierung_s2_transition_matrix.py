...
DRIVER_DIVERGENCE_MESSAGES = Counter(
    {
        ...
        "scope extension state differs from the record-approved family growth": 1,
...
EXPECTED_COMPARISON_COUNTS = {
    ...
    "src/artifact_bridge.py:branch_discovery_handoff_import_payload": 16,
    ...
    "src/workflow_production.py:_run_production_transition_loop": 24,
