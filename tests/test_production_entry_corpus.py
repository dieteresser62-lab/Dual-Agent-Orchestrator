...
SCENARIOS: tuple[dict[str, Any], ...] = (
    ...
    {
        "scenario_id": "resume-finding-source-mismatch",
        "classification": "resuming",
        "state_exists": True,
        "resume": True,
        "mutation": ("finding_handoff_source_run_id", "other-run"),
    },
    {
        "scenario_id": "resume-finding-export-mismatch",
        "classification": "resuming",
        "state_exists": True,
        "resume": True,
        "mutation": ("finding_handoff_export_record_id", "ar1-" + "e" * 64),
    },
    {
