...
EXPECTED_DRIVER_BINDINGS = {
    ...
    "prepare_completion_branch_discovery_handoff": "self._prepare_completion_branch_discovery_handoff",
...
def _dependencies(
    *, bridge: ArtifactBridge | None = None,
    ...
    return WorkflowPersistenceDependencies(
        ...
        prepare_completion_branch_discovery_handoff=_unexpected_dependency,
    )
